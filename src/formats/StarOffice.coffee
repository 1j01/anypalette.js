...
module.exports.read_soc = ({fileContentString})->
...
write_soc = (palette, modern)->
	...
	convert.js2xml {
		...
		elements: [
			...
			{
				type: "element"
				name: if modern then "ooo:color-table" else "office:color-table"
				attributes:
					if modern
...
module.exports.write_staroffice_soc = (palette)->
	write_soc(palette, false)

# I assume this is the format used by OpenOffice.org as well, given the ooo namespace
module.exports.write_libreoffice_soc = (palette)->
	write_soc(palette, true)
